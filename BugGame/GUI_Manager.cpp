...
{
	std::ifstream file;
	file.open(Utils::GetResourceDirectory() + "media/GUI_Interfaces/" + l_interface);
...
bool GUI_Manager::LoadStyle(const std::string& l_file, GUI_Element* l_element) {
	std::ifstream file;
	file.open(Utils::GetResourceDirectory() + "media/GUI_Styles/" + l_file);
	...
	while (std::getline(file, line)) {
		...
		if (type == "State") {
			...
			if (type == "Size") {
				...
				int r, g, b, a = 0;
				keystream >> r >> g >> b >> a;
				TemporaryStyle.m_backgroundColour = sf::Color(r, g, b, a);
			}
				...
				int r, g, b, a = 0;
				keystream >> r >> g >> b >> a;
				TemporaryStyle.m_backgroundImageColour = sf::Color(r, g, b, a);
			}
			else if (type == "TextColor") {
				int r, g, b, a = 0;
				keystream >> r >> g >> b >> a;
				TemporaryStyle.m_textColour = sf::Color(r, g, b, a);
			}
				...
				int r, g, b, a = 0;
				keystream >> r >> g >> b >> a;
				TemporaryStyle.m_elementColour = sf::Color(r, g, b, a);
			}
			else if (type == "Glyph") {
